...
{
    if ((climbing || gravDir != 1 || plat 
        || (playerIsLocked(PL_LOCK_GRAVITY) && !instance_exists(objDischargeDashDash) && !instance_exists(objTeleportPhaser) 
        && !(instance_exists(vehicle) && vehicle.object_index == objItem4)))
