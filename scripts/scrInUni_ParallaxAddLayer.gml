/// scrParallaxAddLayer(bgfile, parallaxX, parallaxY, xspd, yspd, wrapX, wrapY, [offXAbs], [offYAbs], [offXRel], [offYRel], [animspd], [bgL], [bgT], [bgW], [bgH], [bgResourceType])
...
assert(object_index == objInUni_CompoundParallax && event_type == 14, //i checked event_type from within cc and it returned 14. who knows what the proper macro for that is
